@include('Admin/layout/header')
 ...
 <body class="layui-anim layui-anim-up">
  ...
  <!--       <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button> -->
        <button class="layui-btn" onclick="x_admin_show('添加赞助商','/admin/sponsor/create')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        @foreach($list as $k => $v)
          <tr>
            ...
            <td>{{ $v['id'] }}</td>
            <td>{{ $v['s_company'] }}</td>
            <td align="center"><img src="/upload/{{ $v['img_path'] }}" alt="" style="width:80px;height:50px;"></td>
            ...
            @endif
              <a title="编辑"  onclick="x_admin_show('编辑','/admin/sponsor/{{ $v['id'] }}/edit')" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
    ...
    <script>
      ...
      //   layer.confirm('确认要删除'+data.length+'个赞助商吗?',function(index){
      //       //捉到所有被选中的，发异步进行删除
      //       // ajax传值
      //       $.ajaxSetup({
      //           headers: {
